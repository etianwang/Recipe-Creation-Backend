...
export const CATALOG_INGREDIENTS: CatalogIngredient[] = [
  ...
  { name: '粉丝', category: IngredientCategory.SIDE, taste: '滑' },
  { name: '宽粉', category: IngredientCategory.SIDE, taste: '糯' },
  ...
  { name: '苹果', category: IngredientCategory.SIDE, taste: '甜' },
  { name: '梨', category: IngredientCategory.SIDE, taste: '甜' },
  { name: '柠檬', category: IngredientCategory.SIDE, taste: '酸' },
